...
public enum ApiError {
    ...
    PRODUCT_NAME_MAX_CHARACTERS             ("PV-4005", "Size.productRequest.name", HttpStatus.BAD_REQUEST, TITLE_VALIDATION_ERROR),
    PRODUCT_DESCRIPTION_MAX_CHARACTERS      ("PV-4006", "Size.productRequest.description", HttpStatus.BAD_REQUEST, TITLE_VALIDATION_ERROR),
    PRODUCT_CATEGORY_MAX_CHARACTERS         ("PV-4007", "Size.productRequest.category", HttpStatus.BAD_REQUEST, TITLE_VALIDATION_ERROR),
    PRODUCT_BRAND_MAX_CHARACTERS            ("PV-4008", "Size.productRequest.productBrand", HttpStatus.BAD_REQUEST, TITLE_VALIDATION_ERROR),
